...
const _SA_RESTART = 2
const _SA_ONSTACK = 1
const _UMTX_OP_WAIT_UINT = 11
const _UMTX_OP_WAIT_UINT_PRIVATE = 15
const _UMTX_OP_WAKE = 3
const _UMTX_OP_WAKE_PRIVATE = 16
const _SIGHUP = 1
const _SIGINT = 2
const _SIGQUIT = 3
const _SIGILL = 4
